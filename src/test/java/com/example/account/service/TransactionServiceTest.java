...
class TransactionServiceTest {
    ...
    void useAccount_AccountNotFound() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.useBalance(12L,"1234567890",
                        1000L));
    ...
    void cancelAccount_AccountNotFound() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("transactionId","1234567890",
                        1000L));
